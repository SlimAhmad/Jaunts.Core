...
namespace Jaunts.Core.Api.Tests.Unit.Services.Processings.Users
{
    public partial class UserProcessingServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnConfirmEmailIfValidationErrorOccursAndLogItAsync(
            Xeption dependencyValidationException)
        {
            ...
            this.userServiceMock.Setup(service =>
                service.ValidateEmailTokenAsync(It.IsAny<ApplicationUser>(), It.IsAny<string>()))
                    .Throws(dependencyValidationException);

            // when
            ValueTask<ApplicationUser> actualUserResponseTask =
                this.userProcessingService.ValidateEmailTokenAsync(someToken,inputUser.Email);
        ...
        public async Task ShouldThrowDependencyExceptionOnConfirmEmailIfDependencyErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnConfirmEmailIfServiceErrorOccursAndLogItAsync()
        {
            // given
                   ApplicationUser randomUser = CreateRandomUser();
            ApplicationUser inputUser = randomUser;
