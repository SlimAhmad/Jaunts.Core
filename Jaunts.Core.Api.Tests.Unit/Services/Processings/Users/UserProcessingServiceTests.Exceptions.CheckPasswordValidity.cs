...
namespace Jaunts.Core.Api.Tests.Unit.Services.Processings.Users
{
    public partial class UserProcessingServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnCheckPasswordValidityIfValidationErrorOccursAndLogItAsync(
            Xeption dependencyValidationException)
        {
            ...
            this.userServiceMock.Setup(service =>
                service.CheckPasswordRequestAsync(It.IsAny<ApplicationUser>(), It.IsAny<string>()))
                    .Throws(dependencyValidationException);

            // when
            ValueTask<bool> actualUserResponseTask =
                this.userProcessingService.CheckPasswordValidityAsync(someToken,inputUser.Id);
        ...
        public async Task ShouldThrowDependencyExceptionOnCheckPasswordValidityIfDependencyErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnCheckPasswordValidityIfServiceErrorOccursAndLogItAsync()
        {
            // given
                   ApplicationUser randomUser = CreateRandomUser();
            ApplicationUser inputUser = randomUser;
