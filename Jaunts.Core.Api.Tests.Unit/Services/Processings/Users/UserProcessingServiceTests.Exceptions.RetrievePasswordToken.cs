...
namespace Jaunts.Core.Api.Tests.Unit.Services.Processings.Users
{
    public partial class UserProcessingServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnPasswordResetTokenIfValidationErrorOccursAndLogItAsync(
            Xeption dependencyValidationException)
        {
            ...
            ValueTask<string> actualTokenTask =
                this.userProcessingService.PasswordResetTokenAsync(inputUser);
        ...
        public async Task ShouldThrowDependencyExceptionOnPasswordResetTokenIfDependencyErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnPasswordResetTokenIfServiceErrorOccursAndLogItAsync()
        {
            // given
                   ApplicationUser randomUser = CreateRandomUser();
            ApplicationUser inputUser = randomUser;
