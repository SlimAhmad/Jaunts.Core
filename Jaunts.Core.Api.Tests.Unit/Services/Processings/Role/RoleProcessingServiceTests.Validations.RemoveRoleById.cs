...
namespace Jaunts.Core.Api.Tests.Unit.Services.Processings.Role
{
    public partial class RoleProcessingServiceTests
    {
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRemoveRoleByIdIfRoleIdIsInvalidAndLogItAsync()
        {
            // given
            ...
            // when
            ValueTask<bool> upsertRoleTask =
                this.roleProcessingService.RemoveRoleByIdAsync(roleId);
