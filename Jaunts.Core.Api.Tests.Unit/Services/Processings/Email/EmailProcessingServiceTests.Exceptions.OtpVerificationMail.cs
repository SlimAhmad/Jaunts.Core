...
namespace Jaunts.Core.Api.Tests.Unit.Services.Processings.Email
{
    public partial class EmailProcessingServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnSendOtpVerificationMailIfValidationErrorOccursAndLogItAsync(
            Xeption dependencyValidationException)
        {
            ...
            ValueTask<SendEmailResponse> actualEmailResponseTask =
                this.emailProcessingService.SendOtpVerificationMailRequestAsync(someUser,someToken);
        ...
        public async Task ShouldThrowDependencyExceptionOnSendOtpVerificationMailIfDependencyErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnSendOtpVerificationMailIfServiceErrorOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
            SendEmailMessage someSendEmailMessage = CreateSendEmailDetailRequest();
