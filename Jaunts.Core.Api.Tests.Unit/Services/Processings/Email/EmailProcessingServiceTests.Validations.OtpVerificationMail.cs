...
namespace Jaunts.Core.Api.Tests.Unit.Services.Processings.Email
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnOtpVerificationMailIfUserIsNullAsync()
        {
            // given
            ...
            ValueTask<SendEmailResponse> emailTask =
                this.emailProcessingService.SendOtpVerificationMailRequestAsync(nullUser,nullToken);
