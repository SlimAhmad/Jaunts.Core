...
namespace Jaunts.Core.Api.Tests.Unit.Services.Processings.Email
{
    public partial class EmailProcessingServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnSendVerificationMailIfValidationErrorOccursAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyExceptionOnSendVerificationMailIfDependencyErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnSendVerificationMailIfServiceErrorOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
            SendEmailMessage someSendEmailMessage = CreateSendEmailDetailRequest();
