    ...
    public partial class TransactionFeeServiceTests
    {
        ...
        public async Task ShouldThrowDependencyExceptionOnDeleteWhenSqlExceptionOccursAndLogItAsync()
        {
            ...
            this.storageBrokerMock.Setup(broker =>
                broker.SelectTransactionFeeByIdAsync(someTransactionFeeId))
                    .ThrowsAsync(sqlException);

            // when
            ValueTask<TransactionFee> deleteTransactionFeeTask =
                this.transactionFeeService.RemoveTransactionFeeByIdAsync(someTransactionFeeId);

            TransactionFeeDependencyException actualDependencyException =
                await Assert.ThrowsAsync<TransactionFeeDependencyException>(
                    deleteTransactionFeeTask.AsTask);
