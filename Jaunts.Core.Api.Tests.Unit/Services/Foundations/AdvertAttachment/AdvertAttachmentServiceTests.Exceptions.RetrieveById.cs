...
namespace Jaunts.Core.Api.Tests.Unit.Services.Foundations.AdvertAttachments
{
    public partial class AdvertAttachmentServiceTests
    {
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveByIdWhenSqlExceptionOccursAndLogItAsync()
        {
            ...
            // when
            ValueTask<AdvertAttachment> retrieveAdvertAttachmentTask =
                this.AdvertAttachmentService.RetrieveAdvertAttachmentByIdAsync(someAdvertId, someAttachmentId);
            ...
            await Assert.ThrowsAsync<AdvertAttachmentDependencyException>(
                retrieveAdvertAttachmentTask.AsTask);
