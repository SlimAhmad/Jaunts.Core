...
namespace Jaunts.Core.Api.Tests.Unit.Services.Foundations.Users
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveEmailTokenWhenSqlExceptionOccursAndLogItAsync()
        {
            // given
            ...
            ValueTask<string> retrieveUserTask =
                this.userService.RetrieveUserEmailConfirmationTokenAsync(someUser);
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveEmailTokenWhenDbExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnRetrieveEmailTokenWhenDbConcurrencyExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveEmailTokenWhenExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
