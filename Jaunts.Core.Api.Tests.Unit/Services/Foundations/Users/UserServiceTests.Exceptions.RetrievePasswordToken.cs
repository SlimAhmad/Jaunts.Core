...
namespace Jaunts.Core.Api.Tests.Unit.Services.Foundations.Users
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrievePasswordTokenWhenSqlExceptionOccursAndLogItAsync()
        {
            // given
            ...
            ValueTask<string> retrieveUserTask =
                this.userService.RetrieveUserPasswordTokenAsync(someUser);
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrievePasswordTokenWhenDbExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnRetrievePasswordTokenWhenDbConcurrencyExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrievePasswordTokenWhenExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
