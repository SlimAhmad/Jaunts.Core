...
namespace Jaunts.Core.Api.Tests.Unit.Services.Foundations.Users
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnModifyUserPasswordWhenSqlExceptionOccursAndLogItAsync()
        {
            // given
            ...
            ValueTask<ApplicationUser> retrieveUserTask =
                this.userService.ModifyUserPasswordAsync(someUser,someToken,somePassword);
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnModifyUserPasswordWhenDbExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
            string someToken = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnModifyUserPasswordWhenDbConcurrencyExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
            string someToken = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnModifyUserPasswordWhenExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
            string someToken = GetRandomString();
