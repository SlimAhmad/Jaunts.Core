...
namespace Jaunts.Core.Api.Tests.Unit.Services.Foundations.Users
{
    ...
    {
        [Fact]
        public async void ShouldThrowValidationExceptionOnRetrieveTwoFactorTokenWhenUserIsNullAndLogItAsync()
        {
            // given
            ...
            // when
            ValueTask<string> userTokenTask =
                this.userService.RetrieveUserTwoFactorTokenAsync(invalidUser);
