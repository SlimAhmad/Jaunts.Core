...
namespace Jaunts.Core.Api.Tests.Unit.Services.Foundations.Users
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnAddRolesWhenSqlExceptionOccursAndLogItAsync()
        {
            // given
            ...
            ValueTask<ApplicationUser> retrieveUserTask =
                this.userService.AddUserRolesAsync(someUser,someRole);
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnAddRolesWhenDbExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
            string someRole = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnAddRolesWhenDbConcurrencyExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
            string someRole = GetRandomString();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnAddRolesWhenExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
            string someRole = GetRandomString();
