...
namespace Jaunts.Core.Api.Tests.Unit.Services.Foundations.Users
{
    ...
    {
        [Fact]
        public async void ShouldThrowValidationExceptionOnRetrieveEmailTokenWhenUserIsNullAndLogItAsync()
        {
            // given
            ...
            ValueTask<string> createUserTask =
                this.userService.RetrieveUserEmailConfirmationTokenAsync(invalidUser);
