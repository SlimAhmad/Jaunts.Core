...
namespace Jaunts.Core.Api.Tests.Unit.Services.Foundations.Users
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveRolesWhenSqlExceptionOccursAndLogItAsync()
        {
            // given
            ...
            // when
            ValueTask<List<string>> retrieveUserTask =
                this.userService.RetrieveUserRolesAsync(someUser);
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveRolesWhenDbExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnRetrieveRolesWhenDbConcurrencyExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveRolesWhenExceptionOccursAndLogItAsync()
        {
            // given
            ApplicationUser someUser = CreateRandomUser();
