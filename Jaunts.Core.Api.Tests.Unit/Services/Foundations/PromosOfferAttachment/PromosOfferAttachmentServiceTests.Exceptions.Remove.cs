    ...
    public partial class PromosOfferAttachmentServiceTests
    {
        ...
        public async Task ShouldThrowDependencyExceptionOnRemoveWhenSqlExceptionOccursAndLogItAsync()
        {
            ...
            ValueTask<PromosOfferAttachment> removePromosOfferAttachmentTask =
                this.promosOfferAttachmentService.RemovePromosOfferAttachmentByIdAsync(
                    somePromosOfferId,
                    someAttachmentId);
        ...
        public async Task ShouldThrowDependencyExceptionOnRemoveWhenDbExceptionOccursAndLogItAsync()
        {
            ...
            ValueTask<PromosOfferAttachment> removePromosOfferAttachmentTask =
                this.promosOfferAttachmentService.RemovePromosOfferAttachmentByIdAsync
                (somePromosOfferId, someAttachmentId);
        ...
        public async Task ShouldThrowDependencyExceptionOnRemoveWhenDbUpdateConcurrencyExceptionOccursAndLogItAsync()
        {
            ...
            // when
            ValueTask<PromosOfferAttachment> removePromosOfferAttachmentTask =
                this.promosOfferAttachmentService.RemovePromosOfferAttachmentByIdAsync(somePromosOfferId, someAttachmentId);
