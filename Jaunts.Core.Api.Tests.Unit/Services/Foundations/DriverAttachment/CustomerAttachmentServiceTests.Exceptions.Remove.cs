    ...
    public partial class DriverAttachmentServiceTests
    {
        ...
        public async Task ShouldThrowDependencyExceptionOnRemoveWhenSqlExceptionOccursAndLogItAsync()
        {
            ...
            ValueTask<DriverAttachment> removeDriverAttachmentTask =
                this.driverAttachmentService.RemoveDriverAttachmentByIdAsync(
                    someDriverId,
                    someAttachmentId);
        ...
        public async Task ShouldThrowDependencyExceptionOnRemoveWhenDbUpdateConcurrencyExceptionOccursAndLogItAsync()
        {
            ...
            // when
            ValueTask<DriverAttachment> removeDriverAttachmentTask =
                this.driverAttachmentService.RemoveDriverAttachmentByIdAsync(someDriverId, someAttachmentId);
