...
namespace Jaunts.Core.Api.Tests.Unit.Services.Foundations.Emails
{
    public partial class EmailServiceTests
    {
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnForgotPasswordMailIfParametersIsNullAsync()
        {
            // given
            ...
            // when
            ValueTask<SendEmailResponse> UserTask =
                this.emailService.PostForgetPasswordMailRequestAsync(nullUser, nullText, nullText, nullText, nullText);
        ...
        [InlineData("", "", "", "", "", "", "")]
        [InlineData("  ", "  ", " ", " ", " ", " ", " ")]
        public async Task ShouldThrowValidationExceptionOnPostForgotPasswordMailIfParametersIsInvalidAsync(
           ...
           string invalidSubject, string invalidFrom, string invalidToken, string invalidFromName)
        {
            ...
            // when
            ValueTask<SendEmailResponse> UserTask =
                this.emailService.PostForgetPasswordMailRequestAsync(invalidUser, invalidSubject, invalidToken, invalidFrom, invalidFromName);

            EmailValidationException actualEmailValidationException =
                await Assert.ThrowsAsync<EmailValidationException>(UserTask.AsTask);
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnPostForgotPasswordMailIfParametersIsEmptyAsync()
        {
            // given
            ...
            // when
            ValueTask<SendEmailResponse> UserTask =
                this.emailService.PostForgetPasswordMailRequestAsync(emptyUser, emptySubject, emptyToken, emptyFrom, emptyFromName);
