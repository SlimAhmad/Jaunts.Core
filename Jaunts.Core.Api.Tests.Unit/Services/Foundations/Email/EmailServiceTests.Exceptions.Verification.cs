...
namespace Jaunts.Core.Api.Tests.Unit.Services.Foundations.Emails
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnPostVerificationMailRequestIfUrlNotFoundAsync()
        {
            // given
            ...
            ValueTask<SendEmailResponse> retrieveSendEmailResponseTask =
               this.emailService.PostVerificationMailRequestAsync(randomUser,randomSubject, It.IsAny<string>(),It.IsAny<string>(),It.IsAny<string>());
        ...
        public async Task ShouldThrowDependencyExceptionOnPostVerificationMailRequestIfUnauthorizedAsync(
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnPostVerificationMailRequestIfNotFoundOccurredAsync()
        {
            // given
            int randomNegativeNumber = GetNegativeRandomNumber();
            DateTimeOffset randomDateTime = GetRandomDateTime();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnPostVerificationMailRequestIfBadRequestOccurredAsync()
        {
            // given
            int randomNegativeNumber = GetNegativeRandomNumber();
            DateTimeOffset randomDateTime = GetRandomDateTime();
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnPostVerificationMailRequestIfTooManyRequestsOccurredAsync()
        {
            // given
            int randomNegativeNumber = GetNegativeRandomNumber();
            DateTimeOffset randomDateTime = GetRandomDateTime();
